...
.nx-info-lbl { font-family: var(--font-mono); font-size: 11px; color:#999; text-transform: uppercase; }
.nx-info-val { font-family: var(--font-mono); font-size: 11px; color:#ff0;font-weight: bold;  }
