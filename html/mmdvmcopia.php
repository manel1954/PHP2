...
.nx-info-lbl { font-family: var(--font-mono); font-size: 7px; color:#ff0; letter-spacing: .12em; text-transform: uppercase; }
.nx-info-val { font-family: var(--font-mono); font-size: 7px; color: var(--text); letter-spacing: .06em; font-weight: bold; }
